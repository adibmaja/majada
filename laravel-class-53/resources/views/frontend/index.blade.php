...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
  ...
  <!-- 
	...
	<!-- Modernizr JS -->
	<script src="{{asset('frontend2/js/modernizr-2.6.2.min.js')}}"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
				...
				<div class="row">
					<div class="col-md-12">
						<ul id="fh5co-destination-list" class="animate-box">
							<li class="one-forth text-center" style="background-image: url({{asset('frontend2/images/place-1.jpg); ">
								<a href="#">
	...
	<script src="{{asset('frontend2/js/sticky.js')}}"></script>

	<!-- Stellar -->
	<script src="{{asset('frontend2/js/jquery.stellar.min.js')}}"></script>
	<!-- Superfish -->
	<script src="{{asset('frontend2/js/hoverIntent.js')}}"></script>
	<script src="{{asset('frontend2/js/superfish.js')}}"></script>
	<!-- Magnific Popup -->
	<script src="{{asset('frontend2/js/jquery.magnific-popup.min.js')}}"></script>
	<script src="{{asset('frontend2/js/magnific-popup-options.js')}}></script>
	<!-- Date Picker -->
	<script src="{{asset('frontend2/js/bootstrap-datepicker.min.js')}}"></script>
	<!-- CS Select -->
	<script src="{{asset('frontend2/js/classie.js')}}"></script>
	<script src="{{asset('frontend2/js/selectFx.js')}}"></script>
