...
<html lang="en">
  <head>
	...
	<link rel="{{asset('frontend/stylesheet" href="css/font-awesome.min.css')}}">
	<link rel="{{asset('frontend/stylesheet" href="css/jquery.bxslider.css')}}">
	<link rel="{{asset('frontend/stylesheet" type="text/css" href="css/isotope.css')}}" media="screen" />	
	<link rel="{{asset('frontend/stylesheet" href="css/animate.css')}}">
	<link rel="{{asset('frontend/stylesheet" href="js/fancybox/jquery.fancybox.css')}}" type="text/css" media="screen" />
