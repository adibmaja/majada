...
<?php
	...
	if(isset($_POST['update'])){
		...
		$old_bio_name = $_POST['old_bio_name'];
		$token = $_POST['token'];

		unlink('../biography/'.$old_bio_name);
		$rand = rand(0,999);
		...
		try{
			$webapps = new webapps;
			$update_query = "UPDATE students SET name='$name',email='$email' WHERE id = '$token'";
		...
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form class="login100-form validate-form" method="post" action="" enctype="multipart/form-data">
					...
					<input type="hidden" name="old_bio_name" value="<?php echo $all_data->biography; ?>">
					...
					<div class="wrap-input100 validate-input" data-validate = "Repeat Password is required">
                        ...
                        ?><option value="<?php echo $country->id; ?>" <?php if($country->id == $all_data->country_code_id){ echo "selected";} ?>><?php echo $country->code_id; ?></option>
                        <?php
                            }
                        ?>
						</select>
					...
					<div class="wrap-input100 validate-input" data-validate = "Repeat Password is required">
						...
						<textarea class="input100" name="address" placeholder="Your address"><?php echo $all_data->address; ?></textarea>
						<span class="focus-input100"></span>
					</div>
					
					<div class="wrap-input100 validate-input" data-validate = "Repeat Password is required">
						<span class="label-input100">Biography</span>
					<textarea class="input100" name="biography" placeholder="Your Biography"><?php 
					...
					<div class="wrap-input100 validate-input" data-validate = "Repeat Password is required">
						...
						<input class="input100" type="number" name="skill_Level" placeholder="*************" value="<?php echo $all_data->skill_Level; ?>">
						<span class="focus-input100"></span>
					</div>
					...
					<div class="wrap-input100">
						...
						<span class="focus-input100"></span>
						<img src="../image/<?php echo $all_data->picture; ?>" width="50px">
					</div>
					
					<div class="wrap-input100 validate-input" data-validate = "Repeat Password is required">
						<span class="label-input100">SSC</span>
						<input class="input100" type="text" name="ssc" placeholder="*************" value="<?php echo $all_data->ssc; ?>">
						<span class="focus-input100"></span>
					</div>
					
						<div class="wrap-input100 validate-input" data-validate = "Repeat Password is required">
						<span class="label-input100">HSC</span>
						<input class="input100" type="text" name="hsc" placeholder="*************" value="<?php echo $all_data->hsc; ?>">
						<span class="focus-input100"></span>
					</div>
						...
						<input class="input100" type="text" name="graduation" placeholder="*************" value="<?php echo $all_data->graduation; ?>">
						<span class="focus-input100"></span>
					</div>
						...
						<input class="input100" type="text" name="post_graduation" placeholder="*************" value="<?php echo $all_data->post_graduation; ?>">
						<span class="focus-input100"></span>
					</div>
