<?php
	...
	if(isset($_POST['submit'])){
		...
		$bio_file_name = $shuffle.".txt";
		$fopen = fopen("../biography/".$bio_file_name,"w");
		fwrite($fopen,$biography);
		
		try{
			$webapps = new webapps;
			$insert_query = "INSERT INTO students VALUES('','$name','$email','$password','$phone','$country_code_id','$address','$bio_file_name','$main_job_role_id','$skill_Level','$picture','$ssc','$hsc','$graduation','$post_graduation')";
